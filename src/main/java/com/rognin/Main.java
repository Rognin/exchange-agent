...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("You can enter requests with the following structure: " +
                "\"Convert $amount $startingCurrency to $targetCurrency\". " +
                "Please use ISO 4217 Three Letter Currency Codes for currencies. Type \"exit\" to quit.");
